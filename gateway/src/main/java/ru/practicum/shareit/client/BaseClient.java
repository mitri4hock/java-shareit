...
public class BaseClient {
    ...
    protected <T> ResponseEntity<Object> patchP(String path, Long userId, @Nullable Map<String, Object> parameters) {
    ...
    private HttpHeaders defaultHeaders(Long userId) {
        ...
        if (userId != null) {
            headers.set(Constants.HEADER_USER_ID_FIELD, String.valueOf(userId));
        }
        return headers;
    }
